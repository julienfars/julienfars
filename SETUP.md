# Academic Pages — Template Setup

This file preserves the original [Academic Pages](https://academicpages.github.io/) template instructions: how to use the template from scratch, run it locally, and maintain/contribute to the upstream project. It's kept here for reference rather than in the main [README](README.md), which now describes this specific site instead of the template itself.
